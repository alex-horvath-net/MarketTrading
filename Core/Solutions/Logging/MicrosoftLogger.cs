...
public class MicrosoftLogger<T>(Microsoft.Extensions.Logging.ILogger<T> logger) : Core.Business.ILogger<T> where T : class {
    ...
    public void LogDebug<P0>(string messageTemplate, P0 p0) {
        if (logger.IsEnabled(LogLevel.Debug))
            logger.LogDebug(messageTemplate, p0);
    }

    public void LogDebug<P0, P1>(string messageTemplate, P0 p0, P1 p1) {
        if (logger.IsEnabled(LogLevel.Debug))
            logger.LogDebug(messageTemplate, p0, p1);
    }

    public void LogDebug<P0, P1, P2>(string messageTemplate, P0 p0, P1 p1, P2 p2) {
        if (logger.IsEnabled(LogLevel.Debug))
            logger.LogDebug(messageTemplate, p0, p1, p2);
    }
    ...
    public void LogWarning<P0>(string messageTemplate, P0 p0) {
        if (logger.IsEnabled(LogLevel.Warning))
            logger.LogWarning(messageTemplate, p0);
    }

    public void LogWarning<P0, P1>(string messageTemplate, P0 p0, P1 p1) {
        if (logger.IsEnabled(LogLevel.Warning))
            logger.LogWarning(messageTemplate, p0, p1);
    }

    public void LogWarning<P0, P1, P2>(string messageTemplate, P0 p0, P1 p1, P2 p2) {
        if (logger.IsEnabled(LogLevel.Warning))
            logger.LogWarning(messageTemplate, p0, p1, p2);
    }
