...
public static class FindTransactionsExtensions {
    public static IServiceCollection AddFindTransactions(this IServiceCollection services, ConfigurationManager configuration) => services
        .AddScoped<FindTransactions.Triggers.Blazor.ITrigger, FindTransactions.Triggers.Blazor.Trigger>()
    ...
    public static IServiceCollection AddService(this IServiceCollection services, ConfigurationManager configuration) => services
        .AddScoped<FindTransactions.UserStory.IUserStory, FindTransactions.UserStory.WorkFlow>()
        .AddClock()
        .AddFlag()
        .AddValidator()
        .AddRepository();
    ...
    public static IServiceCollection AddClock(this IServiceCollection services) => services
        .AddScoped<FindTransactions.UserStory.WorkFlow.IClock, FindTransactions.WorkSteps.Clock>()
        .AddScoped<FindTransactions.WorkSteps.Clock.IClient, FindTransactions.WorkSteps.Clock.Client>();

    public static IServiceCollection AddFlag(this IServiceCollection services) => services
        .AddScoped<FindTransactions.UserStory.WorkFlow.IFlag, FindTransactions.WorkSteps.Flag>()
        .AddScoped<FindTransactions.WorkSteps.Flag.IClient, FindTransactions.WorkSteps.Flag.Client>();

    public static IServiceCollection AddRepository(this IServiceCollection services) => services
        .AddScoped<FindTransactions.UserStory.WorkFlow.IRepository, FindTransactions.WorkSteps.Repository>()
        .AddScoped<FindTransactions.WorkSteps.Repository.IClient, FindTransactions.WorkSteps.Repository.Client>();


    public static IServiceCollection AddValidator(this IServiceCollection services) => services
        .AddScoped<FindTransactions.UserStory.WorkFlow.IValidator, FindTransactions.WorkSteps.Validator>()
        .AddScoped<FindTransactions.WorkSteps.Validator.IClient, FindTransactions.WorkSteps.Validator.Client>()
        .AddScoped<IValidator<FindTransactions.UserStory.Request>, FindTransactions.WorkSteps.Validator.Client.Technology>();
}
