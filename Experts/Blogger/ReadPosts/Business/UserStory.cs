...
public class UserStory(
    IPresenter presenter, IValidator validator, IRepository repository, ISettings<Settings> settings,
    ILog<UserStory> logger, ITime time) : UserStoryCore<Request, Response, Settings>(validator, settings,  logger, time, nameof(UserStory)), IUserStory {
